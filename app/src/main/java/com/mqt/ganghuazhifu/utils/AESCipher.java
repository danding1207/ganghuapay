...
public class AESCipher {
	...
	public static void main() throws Exception {
		String content = "";
		Logger.t("AESCipher").i("加密前：" + content);
		String key = "16BytesLengthKey";
		Logger.t("AESCipher").i("加密密钥和解密密钥：" + key);
		String encrypt = encryptAES(content, key);
		Logger.t("AESCipher").i("加密后：" + encrypt);
		String decrypt = decryptAES(encrypt, key);
		Logger.t("AESCipher").i("解密后：" + decrypt);
	}
	...
	public static byte[] base64Decode(String base64Code) throws Exception {
		return base64Code == null || base64Code.equals("") ? null
				: Base64.decode(base64Code, Base64.DEFAULT);
	}
