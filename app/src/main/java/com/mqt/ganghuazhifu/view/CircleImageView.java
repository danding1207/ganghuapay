...
public class CircleImageView extends ImageView {
	...
	private RectF rectf;
	private float tb;
	private int blackColor = 0xffffffff; // 搴曢粦鑹�
	private int whiteColor = 0xffffffff; // 鐧借壊
	private int score;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawCircle(getWidth() / 2, getHeight() / 2, mDrawableRadius,
				mBitmapPaint);
		canvas.drawArc(new RectF(tb * 0.2f,tb * 0.2f, getWidth()-tb * 0.2f, getHeight()-tb * 0.2f), -90, 360, false, paint_black);
		canvas.drawArc(new RectF(tb * 0.2f,tb * 0.2f, getWidth()-tb * 0.2f, getHeight()-tb * 0.2f), -90, arc_y, false, paint_white);
