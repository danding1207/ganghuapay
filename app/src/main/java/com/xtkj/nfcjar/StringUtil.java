...
public class StringUtil {
    ...
    public static byte[] getNumByte3(int num) {
        byte[] bot = new byte[]{(byte)(num & 255), (byte)(num >> 8 & 255), (byte)(num >> 16 & 255)};
        return bot;
    }
    ...
    public static String getHex(int num, double res) {
        ...
        case 3:
            result = "000000";
            bs = new byte[]{(byte)(in >> 24 & 255), (byte)(in >> 16 & 255), (byte)(in >> 8 & 255)};
            result = byte2HexString(bs);
            break;
        case 4:
            result = "00000000";
    ...
    public static String getPriceGroupString(PriceGroup priceGroup) {
        StringBuffer buffer = new StringBuffer();
        buffer.append(getHex(2, priceGroup.price1));
        buffer.append(getHex(3, priceGroup.divideCount1));
        buffer.append(getHex(2, priceGroup.price2));
        buffer.append(getHex(3, priceGroup.divideCount2));
        buffer.append(getHex(2, priceGroup.price3));
        buffer.append(getHex(3, priceGroup.divideCount3));
        buffer.append(getHex(2, priceGroup.price4));
        buffer.append(getHex(3, priceGroup.divideCount4));
        buffer.append(getHex(2, priceGroup.price5));
        return buffer.toString();
    }
